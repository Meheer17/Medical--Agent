...
import com.nithin.healthapp.databinding.FragmentDoctorQueriesBinding
import com.nithin.healthapp.ui.common.QueryAdapter
...
class DoctorQueriesFragment : Fragment() {
    ...
    private fun showRespondDialog(query: com.nithin.healthapp.data.models.QueryResponse) {
